...
{	
{
	if(unidad1.value=="" || unidad2.value==""){
		txtResultado.innerHTML = "Select a unit to measure";
	}
	if(unidad1.value=="Kilometro" && unidad2.value=="Kilometro"){
		txtResultado.innerHTML = "Select different measure units";
	}
...

{
	...
	if(unidad1.value=="Hectometro" && unidad2.value=="Hectometro"){
		txtResultado.innerHTML = txtResultado.innerHTML = "Select different measure units";;
	}
